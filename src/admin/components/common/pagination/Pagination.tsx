...
import type { TablePaginationProps } from '@admin/types/table-pagination.type';
import { Form } from "react-bootstrap";
import SvgLeftControlIcon from '@admin/components/icons/left-control-icon';
import SvgRightControlIcon from '@admin/components/icons/right-control-icon';
